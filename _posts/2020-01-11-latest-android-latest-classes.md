---
id: 1995
title: Latest Android classes
date: 2014-01-10 00:20:43
author: taimane
layout: post
permalink: /android/classes-kitkat/
redirect_from: /latest-android-latest-classes/
published: true
categories:
   -
tags:
   -
---
These are all Android 4.4 KitKat classes sorted from android.jar. All the classes are listed in  alphabetical order.

```
AbortableHttpRequest.class
AbsListView.class
AbsListView$LayoutParams.class
AbsListView$MultiChoiceModeListener.class
AbsListView$OnScrollListener.class
AbsListView$RecyclerListener.class
AbsListView$SelectionBoundsAdjuster.class
AbsoluteLayout.class
AbsoluteLayout$LayoutParams.class
...
AbstractCursor$SelfContentObserver.class
...
CalendarContract$RemindersColumns.class
...
Contacts$People$ContactMethods.class
...
DrmStore.class
DrmStore$ConstraintsColumns.class
...
KeyStore$PasswordProtection.class
...
MediaRecorder$VideoEncoder.class
...
MediaStore$Images$ImageColumns.class
...
RenamingDelegatingContext.class
RenderScript.class
...
ViewTreeObserver$OnWindowAttachListener.class
