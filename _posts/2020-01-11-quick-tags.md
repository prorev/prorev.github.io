...
We can add the `<pre>` button similar to the `<code>` button, but we do not like to edit this file directly, because it is bad practice to edit the WordPress core files.
 
Our solution is to reassign quicktags to load from our custom <a rel="nofollow" href="https://brettterpstra.com/edit-your-wordpress-quicktags-the-right-way/">file</a>:
...
My quicktags.js looks like this and is stored in the theme `/js` folder.
...
![pre](https://programming-review.com/wp-content/uploads/2012/10/Selection_274.png)
