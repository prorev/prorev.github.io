...
author: taimane
layout: post
permalink: /wordpress/new-custom-post-type/
redirect_from: /register-new-custom-post-type-for-videos-and-add-taxonomy-videos/
published: true
categories:
   -
tags:
   -
---
In here we register new custom post type for **Videos** and add new taxonomy **videos**.
...
Similar to register CPT `articles` on `init` method.
