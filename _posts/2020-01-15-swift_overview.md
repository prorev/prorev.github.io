...
From the very start Swift was designed to be expressive, flexible, and fast. It was design to express complex programming design patterns with ease and also deal with hardware and low level system stuff. Yes, you can write _bootloaders_ in Swift.
