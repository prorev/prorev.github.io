...
_**print** prints its argument and returns it _invisibly_ (via **invisible(x)**). It is a generic function which means that new printing methods can be easily added for new classes._
