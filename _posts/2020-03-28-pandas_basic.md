...
Note how we set the **na_values**. Anything inside that array will be treated as NaN.
...
To get info on a particular column.
...
```
![scatter matrix](/wp-content/uploads/2020/04/scattermatrix.jpg)
