...
author: taimane
description: Explains the process of Automatic Differentiation in PyTorch, covers reverse mode AD and implements the whole process in Python (simplified) to cover the example function with two parameters
layout: post
